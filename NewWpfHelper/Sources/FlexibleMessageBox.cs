    ...
    public class FlexibleMessageBox
    {
        ...
        private class FlexibleMessageBoxForm : Form
        {
            ...
            private static string[] GetStringRows(string message)
            {
                ...
                var messageRows = message.Split(new string[] {Environment.NewLine.ToString()}, StringSplitOptions.None);
                return messageRows;
            }
            ...
            {
                return this._isCultureGerman
                    ? BUTTON_TEXTS_GERMAN[Convert.ToInt32(buttonTextIndex)]
            ...
            private static void SetDialogSizes(FlexibleMessageBoxForm flexibleMessageBoxForm, string text)
            {
                ...
                {
                    maxTextRowHeight = graphics.MeasureString("1", FONT).Height;
